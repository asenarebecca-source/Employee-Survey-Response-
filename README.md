...
![](https://github.com/asenarebecca-source/Employee-Survey-Response-/blob/main/WhatsApp%20Image%202026-06-30%20at%2009.23.57.jpeg)


## Project Overview

This project analyzes an Employee Satisfaction Survey dataset to assess employee perceptions across departments and job roles. The objective was to identify organizational strengths, uncover opportunities for improvement, and provide data-driven recommendations to support employee satisfaction.
...
The organization recorded an average employee satisfaction score of 3.1, indicating generally positive responses with room for improvement.
...
This dashboard shows that employee satisfaction is generally positive, but the results also reveal differences across departments and positions. 

Leadership roles such as Directors and Managers reported higher satisfaction than Staff, suggesting that employees in more operational roles may need stronger support, better communication, and greater opportunities for recognition and growth. 

To improve results, the organization should take a targeted approach by reviewing low-scoring survey topics, addressing department-specific concerns, and tailoring actions to each position level. 
